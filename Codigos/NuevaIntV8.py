...
def open_img():
    ...
    if ruta_imagen:
        try:
            ...
            plt.title('Precisión de la predicción por clase', fontsize=10)
            ...
            label_resultado = customtkinter.CTkLabel(master=prediction_frame, text=f"Clase Predicha: {nombre_clase_predicha}", font=customtkinter.CTkFont(size=18, weight="bold"))
            label_resultado.grid(row=0, column=0, padx=10, pady=10)

            # Mostrar el porcentaje de asertividad en un label
            label_porcentaje_acertividad = customtkinter.CTkLabel(master=prediction_frame, text=f"  Porcentaje de Precisión: {precision:.2f}%", font=customtkinter.CTkFont(size=18, weight="bold"))
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.appearance_mode_menu = customtkinter.CTkOptionMenu(self.navigation_frame, values=["Dark", "Light", "System"],  fg_color="#7DC488", text_color="black",
        ...
        self.home_frame_button_1.grid(row=1, column=0, padx=40, pady=10)
        ...
        self.home_frame_button_2.grid(row=1, column=1, padx=60, pady=10)
        ...
        self.home_frame_button_3.grid(row=1, column=3, padx=10, pady=10)
        ...
        self.second_frame_1_button = customtkinter.CTkButton(self.frame_buttons, text="TALITA", command=lambda: self.select_second_frame("second_frame_1"),fg_color="#7DC488", text_color="black", hover_color="#B4BAB5")
        self.second_frame_1_button.grid(row=0, column=0, padx=10)
    
        self.second_frame_2_button = customtkinter.CTkButton(self.frame_buttons, text="Alzheimer México, I.A.P.®", command=lambda: self.select_second_frame("second_frame_2"), fg_color="#7DC488", text_color="black", hover_color="#B4BAB5")
        self.second_frame_2_button.grid(row=0, column=1, padx=10)

        self.second_manual_button = customtkinter.CTkButton(self.frame_buttons, text="Fundación Alzheimer", command=lambda: self.select_second_frame("second_frame_3"),fg_color="#7DC488", text_color="black", hover_color="#B4BAB5")
        self.second_manual_button.grid(row=0, column=2, padx=10)
        self.second_manual_button = customtkinter.CTkButton(self.frame_buttons, text="Centro Mexicano Alzheimer", command=lambda: self.select_second_frame("second_frame_4"),fg_color="#7DC488", text_color="black", hover_color="#B4BAB5")
        self.second_manual_button.grid(row=0, column=3, padx=10)
        self.second_manual_button = customtkinter.CTkButton(self.frame_buttons, width=10, text="AMAyES", command=lambda: self.select_second_frame("second_frame_5"),fg_color="#7DC488", text_color="black", hover_color="#B4BAB5")
        self.second_manual_button.grid(row=0, column=4, padx=5)
        ...
        self.directorio_label1.grid(row=0, column=2, padx=40, pady=10, columnspan=5)
        self.directorio_label2 = customtkinter.CTkLabel(self.second_frame_1,compound="left", text="Dirección : \nFuente de la Bastilla 44 Lomas de Tecamachalco, Estado de México", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label2.grid(row=1, column=2, padx=70, pady=0)
        self.directorio_label3 = customtkinter.CTkLabel(self.second_frame_1,compound="center", text="Teléfono : \n55-7825-8035", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label3.grid(row=2, column=2, padx=60, pady=10)
        self.directorio_label4 = customtkinter.CTkLabel(self.second_frame_1,compound="center", text="E-mail : \ninfo@talita.com.mx", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label4.grid(row=3, column=2, padx=60, pady=0)
        ...
        self.directorio_label4.grid(row=5, column=2, padx=10, pady=10)
         # Agrega el mapa
        self.mapa_1 = TkinterMapView(self.second_frame_1, width=620, height=400, corner_radius=0)
        self.mapa_1.grid(row=6, column=2, padx=10, pady=10)
       ...
       # PARA LA PAGINA 2 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.directorio_img = customtkinter.CTkImage(Image.open(os.path.join(image_path, "O2.jpg")), size=(40, 40))
        self.directorio_label1=customtkinter.CTkLabel(self.second_frame_2, image=self.directorio_img, compound="left", text="")
        self.directorio_label1.grid(row=0, column=1, padx=10, pady=10)
        self.directorio_label1 = customtkinter.CTkLabel(self.second_frame_2, text="Alzheimer México, I.A.P.®",
                                                             compound="center", font=customtkinter.CTkFont(size=22, weight="bold"))
        self.directorio_label1.grid(row=0, column=2, padx=40, pady=10, columnspan=5)
        self.directorio_label2 = customtkinter.CTkLabel(self.second_frame_2,compound="center", text="Dirección : \nCalle Moneda #90, Col. Tlalpan Centro, Alcaldía Tlalpan, CDMX", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label2.grid(row=1, column=2, padx=70, pady=0)
        self.directorio_label3 = customtkinter.CTkLabel(self.second_frame_2,compound="center", text="Teléfono : \n55 52804202, 55 52803349", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label3.grid(row=2, column=2, padx=60, pady=10)
        self.directorio_label4 = customtkinter.CTkLabel(self.second_frame_2,compound="center", text="E-mail : \ninfo@alzheimermexico.org.mx", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label4.grid(row=3, column=2, padx=60, pady=0)
        ...
        self.mapa_1.grid(row=6, column=2, padx=10, pady=10)
        self.mapa_1.set_tile_server("https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=26)
        self.mapa_1.set_marker(19.289934361697657, -99.16964744031561, text="Alzheimer México, I.A.P.®", text_color="black", font=("Consolas", 16,"bold")) #Coordenadas del marcador
        self.mapa_1.set_position(19.289934361697657, -99.16964744031561)  # Coordenadas de Ciudad de México
        # self.mapa_1.set_zoom(15)
        
        #PARA LA PAGINA 3 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.directorio_img = customtkinter.CTkImage(Image.open(os.path.join(image_path, "O3.jpg")), size=(40, 40))
        self.directorio_label1=customtkinter.CTkLabel(self.second_frame_3, image=self.directorio_img, compound="left", text="")
        self.directorio_label1.grid(row=0, column=1, padx=10, pady=10)
        self.directorio_label1 = customtkinter.CTkLabel(self.second_frame_3, text="Fundación Alzheimer",
                                                             compound="center", font=customtkinter.CTkFont(size=22, weight="bold"))
        self.directorio_label1.grid(row=0, column=2, padx=40, pady=10, columnspan=5)
        self.directorio_label2 = customtkinter.CTkLabel(self.second_frame_3,compound="center", text="Dirección : \nDivisión del Norte #1044 Col. Narvarte, C.P. 03020 México D.F.", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label2.grid(row=1, column=2, padx=70, pady=0)
        self.directorio_label3 = customtkinter.CTkLabel(self.second_frame_3,compound="center", text="Teléfono : \n55 5575 8320", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label3.grid(row=2, column=2, padx=60, pady=10)
        self.directorio_label4 = customtkinter.CTkLabel(self.second_frame_3,compound="center", text="E-mail : \ncontacto@alzheimer.org.mx", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label4.grid(row=3, column=2, padx=60, pady=0)
        ...
        self.mapa_1.grid(row=6, column=2, padx=10, pady=10)
        self.mapa_1.set_tile_server("https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=26)
        self.mapa_1.set_marker(19.383295461892914, -99.16010959665499, text="Fundación Alzheimer", text_color="black", font=("Consolas", 16,"bold")) #Coordenadas del marcador
        self.mapa_1.set_position(19.383295461892914, -99.16010959665499)  # Coordenadas de Ciudad de México
        # self.mapa_1.set_zoom(15)
#PARA LA PAGINA 4 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.directorio_label5 = customtkinter.CTkLabel(self.second_frame_4,compound="left", text="")
        self.directorio_label5.grid(row=0, column=1, padx=10, pady=0)
        self.directorio_label1 = customtkinter.CTkLabel(self.second_frame_4, text="Centro Mexicano Alzheimer A.C.",
                                                             compound="center", font=customtkinter.CTkFont(size=22, weight="bold"))
        self.directorio_label1.grid(row=0, column=2, padx=40, pady=10, columnspan=5)
        self.directorio_label2 = customtkinter.CTkLabel(self.second_frame_4,compound="center", text="Dirección : \nAv. Insurgentes Sur 2047-Edificio B, San Ángel, Álvaro Obregón, CDMX", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label2.grid(row=1, column=2, padx=70, pady=0)
        self.directorio_label3 = customtkinter.CTkLabel(self.second_frame_4,compound="center", text="Teléfono : \n5589914000", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label3.grid(row=2, column=2, padx=60, pady=10)
        self.directorio_label4 = customtkinter.CTkLabel(self.second_frame_4,compound="center", text="", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label4.grid(row=3, column=2, padx=60, pady=0)
        ...
        self.mapa_1.grid(row=6, column=2, padx=10, pady=10)
        self.mapa_1.set_tile_server("https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=26)
        self.mapa_1.set_marker(19.3535012628888, -99.18764853953996, text="Centro Mexicano Alzheimer A.C.", text_color="black", font=("Consolas", 16,"bold")) #Coordenadas del marcador
        self.mapa_1.set_position(19.3535012628888, -99.18764853953996)  # Coordenadas de Ciudad de México
        # self.mapa_1.set_zoom(15)
        #PARA LA PAGINA 5 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.directorio_label5 = customtkinter.CTkLabel(self.second_frame_5,compound="left", text="")
        self.directorio_label5.grid(row=0, column=1, padx=10, pady=0)
        self.directorio_label1 = customtkinter.CTkLabel(self.second_frame_5, text="Asociación Mexicana de Alzheimer \ny Enfermedades Similares A.C.",
                                                             compound="center", font=customtkinter.CTkFont(size=22, weight="bold"))
        self.directorio_label1.grid(row=0, column=2, padx=40, pady=10, columnspan=5)
        self.directorio_label2 = customtkinter.CTkLabel(self.second_frame_5,compound="center", text="Dirección : \nAralia 22, Tlacopac, Álvaro Obregón, 01049 Ciudad de México, CDMX", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label2.grid(row=1, column=2, padx=70, pady=0)
        self.directorio_label3 = customtkinter.CTkLabel(self.second_frame_5,compound="center", text="Teléfono : \n55231526", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label3.grid(row=2, column=2, padx=60, pady=10)
        self.directorio_label4 = customtkinter.CTkLabel(self.second_frame_5,compound="center", text="", font=customtkinter.CTkFont(size=16, weight="bold"))
        self.directorio_label4.grid(row=3, column=2, padx=60, pady=0)
        ...
        self.mapa_1.grid(row=6, column=2, padx=10, pady=10)
        self.mapa_1.set_tile_server("https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=26)
        self.mapa_1.set_marker(19.36335520106311, -99.19742264833832, text="AMAyES.", text_color="black", font=("Consolas", 16,"bold")) #Coordenadas del marcador
        self.mapa_1.set_position(19.36335520106311, -99.19742264833832 )  # Coordenadas de Ciudad de México
        # self.mapa_1.set_zoom(15)
        ...
        self.manual_doc = CTkPDFViewer(self.manual_frame,file="Manual.pdf", height=900, width=800, page_separation_height= 2)
